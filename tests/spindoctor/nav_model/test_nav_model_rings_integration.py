...
from spindoctor.nav_model.rings.ring_types import RingBaseOrbitMode, RingEdgeData, RingFeatureType
...
def _build_sparse_check_model(
    ...
    from spindoctor.nav_model import nav_model_rings as rings_module
