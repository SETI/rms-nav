"""Tests for spindoctor.reproj shared modules: BodyMosaicMergeStrategy,
...
from spindoctor.reproj.bodies import BodyMosaicMergeStrategy
...
from spindoctor.reproj.rings import RingMosaicMergeStrategy
