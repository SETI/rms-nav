"""FITS serialization edge cases in ``spindoctor.reproj._serialization``."""
...
from spindoctor.reproj._serialization import infer_format, load_fits, orbit_model_to_dict, save_fits
from spindoctor.reproj.rings import RingReprojResult
