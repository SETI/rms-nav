"""Tests for ``spindoctor.ui.common``."""
...
# If this file is collected without ``tests/spindoctor/ui/conftest.py`` (unusual), still
...
try:
    ...
    pytest.skip(
        f'spindoctor.ui.common import failed (Qt dependency): {exc}',
        allow_module_level=True,
    )
