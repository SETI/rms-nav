...
class MockObservation:
    ...
    def __init__(self, midtime=None):
...
def test_load_features_no_date_range(ring_model):
...
def test_load_features_within_date_range():
...
def test_load_features_before_date_range():
...
def test_load_features_after_date_range():
...
def test_load_features_only_start_date():
...
def test_load_features_only_end_date():
...
def test_load_features_invalid_type(ring_model):
...
def test_load_features_no_edges(ring_model):
...
def test_validate_mode_data_valid(ring_model):
...
def test_validate_mode_data_missing_mode(ring_model):
    ...
    assert not ring_model._validate_mode_data(
        mode_data, feature_key='test_feature', edge_type='inner', min_radius=0.0, max_radius=1e6)


def test_validate_mode_data_non_positive_a(ring_model):
...
def test_get_base_radius(ring_model):
...
def test_get_base_radius_no_mode_1(ring_model):
...
def test_load_features_radius_filtering(ring_model):
    ...
    features = ring_model._load_ring_features(
        planet_config, ring_model.obs.midtime, min_radius=min_radius, max_radius=max_radius)
...
def test_load_features_radius_filtering_inner_edge_out_of_range(ring_model):
...
def test_load_features_radius_filtering_outer_edge_out_of_range(ring_model):
...
def test_load_features_radius_filtering_gap_with_single_edge(ring_model):
