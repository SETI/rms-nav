...
document exists -- whether that document records a fatal error of a particular
kind.  Asked of the tree, those cost one directory walk per selected volume plus
...
def _stub_query(
    ...
    # A refused file records no status, so it matches no error filter.
