...
# floors live): the smallest confidence at which each tier's
# sigma-gated subset of the campaign's fused results achieves a 0.9
# success rate against the tier's error budget.  The medium tier's
...
DEFAULT_TIER_THRESHOLDS: dict[str, dict[str, float | None]] = {
    'high': {'min_confidence': 0.55, 'max_sigma_px': 0.5},
