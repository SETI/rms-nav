...
view and emit one :class:`~spindoctor.feature.feature.NavFeature` per surviving star. All
concrete subclasses derive from :class:`~spindoctor.nav_model.nav_model.NavModel` directly; the
